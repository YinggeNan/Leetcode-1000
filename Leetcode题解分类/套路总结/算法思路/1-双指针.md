...
## 一.基本问题
#### (1) Leetcode-167.[Two Sum II - Input array is sorted (Easy)](https://leetcode-cn.com/problems/two-sum-ii-input-array-is-sorted/)
...
#### 思路4-费马平方和定理
#### (3) leetcode-345.[Reverse Vowels of a String (Easy)](https://leetcode-cn.com/problems/reverse-vowels-of-a-string/)
题目描述：反转字符串中的元音字母  
>双指针题眼->翻转:针对镜像的两个元素才叫翻转

思路：双指针，只有left、right都是元音字母时才互换，否则继续向中间走，注意元音字母包含大小写，{'a','e','i','o','u','A','E','I','O','U'}
#### (4) leetcode-680.[Valid Palindrome II (Easy)](https://leetcode-cn.com/problems/valid-palindrome-ii/)
...
```
#### (5) leetcode-88.[Merge Sorted Array (Easy)](https://leetcode-cn.com/problems/merge-sorted-array/)
>双指针题眼->两个有序数组
...
```
#### (6) leetcode-141.[Linked List Cycle (Easy)](https://leetcode-cn.com/problems/linked-list-cycle/)
>快慢指针判断链表存在环

题目描述：给定一个链表，判断链表中是否有环，请使用O(1)空间解决
#### (7) leecode-524.[Longest Word in Dictionary through Deleting (Medium)](https://leetcode-cn.com/problems/longest-word-in-dictionary-through-deleting/)
...
#### (11) leetcode-922.按奇偶排序数组 II

## 二.sum问题
第 1 题，第 15 题，第 16 题，第 18 题，第 167 题，第 923 题，第 1074 题。
